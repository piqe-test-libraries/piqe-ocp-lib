...
class OcpResourceQuota(OcpBase):
    ...
    def __init__(self, kube_config_file=None):
        super(OcpResourceQuota, self).__init__(kube_config_file=kube_config_file)
        self.api_version = "v1"
    ...
    def delete_a_resource_quota(self, name: str, namespace: str) -> ResourceInstance:
        ...
        ResourceInstance[ResourceQuota]:
          apiVersion: v1
          kind: ResourceQuota
          metadata:
            creationTimestamp: '2021-02-19T00:08:46Z'
            managedFields:
            - apiVersion: v1
              fieldsType: FieldsV1
              fieldsV1:
            ...
            name: test23904
            namespace: default
            resourceVersion: '11519131'
            selfLink: /api/v1/namespaces/default/resourcequotas/test23904
            uid: 55e4e249-abdb-49f8-944b-0b00b7171a46
          spec:
            hard:
              requests.cpu: 1200M
...
class AutoEnum(Enum):
    """
    AutoEnum Class is an Enum that overrides the default value generator function so that
...
class OcpScopeSelectorExpression(object):
    """
...
class OcpResourceQuotaSpec(object):
    """
