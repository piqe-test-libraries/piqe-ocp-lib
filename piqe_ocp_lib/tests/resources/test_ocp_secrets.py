...
SA_TOKEN = "ZXlKaGJHY2lPaUpTVXpJMU5pSXNJbXRwWkNJNklpSjkuZXlKcGMzTWlPaUpyZFdKbGNtNWxkR1Z6TDNObGNuWnBZMlZoWT" \
...
class TestOcpSecrets:
    ...
    def test_create_secret(self, ocp_secret):
        ...
        if secret_token_response and secret_token_response["kind"] == "Secret" and \
                secret_token_response["metadata"]["name"] == SA_TOKEN_NAME:
